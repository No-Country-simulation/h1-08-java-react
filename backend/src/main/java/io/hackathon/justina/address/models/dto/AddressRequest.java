...
public class AddressRequest {
    ...
    @Pattern(regexp = "^[a-zA-Z ñÑºüÜáéíóú]+$", message = "La provincia solo debe contener letras")
    @Size(min = 3, max = 30, message = "La provincia no puede tener menos de 3 caracteres ni más de 50 caracteres")
    private String province;

    @Pattern(regexp = "^[a-zA-Z ñÑºüÜáéíóú]+$", message = "La ciudad solo debe contener letras")
