package io.hackathon.justina.JWT.Filters;
            ...
            try {
                ...
                if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
                    ...
                    if (jwtService.validateToken(token, userDetails)) {
                        EmailPasswordAuthenticationToken authToken =
                                new EmailPasswordAuthenticationToken(userDetails.getUsername(), null, userDetails.getAuthorities());
